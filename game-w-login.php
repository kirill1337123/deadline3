...
<?php 
  ...
  <form class="form-registration">
    ...
    <div class="login-form" id="loginform123">
      <?php 
        ...
        font-size: 1.2em;
        text-align: center;
        color: #7fffd4;">[Вы]: '.$_SESSION['logged_user']->login.'</p>'; */
      ?>
    </div>
    <p><a class="registration" href="index.php">Выйти</a></p>
  </div>
   </form>
   <h1 class = "add"></h1>
   <div class="main-menu">
...
<div class="results-and-img">
  <form class="form-your-results">
    ...
    <h1 class="your-results-score" id="your-results-score">
        <?php 
        echo ''.$_SESSION['logged_user']->score.' sec';
        ?>
